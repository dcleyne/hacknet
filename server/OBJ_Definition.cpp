...
objPrototype g_objectPrototype[] =
		{
				...
				/* missiles */PROJECTILE("arrow", (char *)0,
				...
				/* two-piece */WEAPON("aklys", "thonged club",
...
#undef BOW
				...
				/* helmets */HELM("elven leather helm", "leather hat",
...
#undef DRGN_ARMR
				...
				/* shields */SHIELD("small shield", (char *)0,
				...
				/* boots */BOOTS("low boots", "walking shoes",
				...
				/* scrolls ... */SCROLL("enchant armor", "ZELGO MER", 1, 63, 80),
