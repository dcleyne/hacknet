...
//	void			SetName( char * name );
	...
	virtual void Think()
	{
	} // Called to decide what to do each turn.
	...
	virtual bool FindMoveDestination(hnPoint & destination,
			hnDirection direction); // pass in the direction and a place to store the destination point.  Returns true if it's a legal move.
	...
	{
	} // Called before processing a turn
	virtual void PostTurn()
	{
	} // Called after processing a turn
