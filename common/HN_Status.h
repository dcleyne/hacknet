...
public:
	...
	uint8 GetStrength()
	{
		return m_statistic[Strength];
	}
	uint8 GetDexterity()
	{
		return m_statistic[Dexterity];
	}
	uint8 GetConstitution()
	{
		return m_statistic[Constitution];
	}
	uint8 GetIntelligence()
	{
		return m_statistic[Intelligence];
	}
	uint8 GetWisdom()
	{
		return m_statistic[Wisdom];
	}
	uint8 GetCharisma()
	{
		return m_statistic[Charisma];
	}
	uint8 GetStatistic(statisticType type)
	{
		return m_statistic[type];
	}
	...
	uint16 Hallucinating()
	{
		return m_hallucinating;
	}
	...
	uint16 HallucinatingTime(uint16 timer)
	{
		m_hallucinating = timer;
		return m_hallucinating;
	}
	void RegainLevel();
