...
public:
	...
	bool Done()
	{
		return m_bufferDistance >= m_bufferLength;
	}
	...
	bool ObjectName(uint16 &objectID, uint16 & type, char * nameBuffer,
			sint16 & bufferLength);
	bool JoinOK();
	bool QuitConfirm();
	bool SaveConfirm();
...
public:
	...
	} // tell how many bytes we actually wrote, not how big our buffer was
